  ...
  return (
    <div>
      ...
      <div className="flex h-[calc(100vh-64px)]">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {!hasAccess && !currentLesson?.is_free && (
            ...
            >
              ...
              <h2 className="text-xl font-bold text-white mb-2">Khoá học này yêu cầu đăng ký</h2>
          ...
          {(hasAccess || currentLesson?.is_free) && currentLesson && (
            <>
              ...
              {currentLesson.content && (
                <div className="card-dark p-5 mb-5 prose prose-invert prose-sm max-w-none">
        ...
        <aside
          className="w-80 overflow-y-auto border-l border-[#2a2a2a] shrink-0"
