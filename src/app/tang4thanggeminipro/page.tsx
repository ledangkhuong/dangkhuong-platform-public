...
export const metadata: Metadata = {
  ...
  description:
    "Nhận ngay 4 tháng Gemini Pro miễn phí từ Google — 1000 credit/tháng, tiết kiệm hơn 2 triệu. Hướng dẫn chi tiết + tài liệu bí mật video AI triệu view. Hoàn toàn miễn phí!",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Nhận 4 tháng Gemini Pro miễn phí, 1000 credit/tháng. Hướng dẫn đăng ký + tài liệu video AI triệu view. Hoàn toàn miễn phí!",
    type: "website",
